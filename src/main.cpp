      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          //predict variable state 100ms in advance to include 100ms sleep
          double dt = .1;
          ...
          double epsi_delay = epsi - v * steer_value/Lf * dt;

          Eigen::VectorXd state(6);
          state << x, y, psi_delay, v_delay, cte_delay, epsi_delay;
