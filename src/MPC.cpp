...
size_t x_start = 0;
size_t y_start = x_start + N; //10 x
size_t psi_start = y_start + N; //10 y
size_t v_start = psi_start + N; // 10 v
size_t cte_start = v_start + N; // 10 cte
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    std::cout<<"Rest of the constrainst"<<std::endl;
    std::cout<<vars;
